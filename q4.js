const data = `iyr:2013 hcl:#ceb3a1
hgt:151cm eyr:2030
byr:1943 ecl:grn
...
const checkKey = (code) => {
  ...
  let testPassport = code.match(/(byr:|hcl:|hgt:|ecl:|eyr:|iyr:|pid:)/g);
  //   console.log(testPassport);
  if (testPassport.length == 7) {
    counter++;
  }
};
//here we take control on the seperate lines
// const multiLineTo1 = (code) => {
//   let arrayOfLines = code.split("\n");
//   console.log(arrayOfLines);
//   let singleLine = "";
//   arrayOfLines.forEach((line) => (singleLine += line));
//   return singleLine;
//   //   checkKey(singleLine);
// };
//send each code of passport to multilineTo1
splitData.forEach((element) => {
  checkKey(element);
});
console.log(counter);
//concat seprate line to one line
